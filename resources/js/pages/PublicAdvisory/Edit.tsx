// resources/js/Pages/PublicAdvisory/Edit.tsx
...
export default function PublicAdvisoryEdit({ advisory }: Props) {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        const loadingToast = toast.loading('Updating advisory...');

        router.put(`/public-advisories/${advisory.id}`, formData, {
            onSuccess: () => {
        ...
        <DashboardLayout>
            ...
            >
                ...
                <motion.div variants={itemVariants} className="mb-6">
                    ...
                    <h1 className="text-2xl font-bold text-gray-900">Edit Advisory</h1>
                </motion.div>
                ...
                >
                    ...
                    <div className="flex justify-end space-x-3 pt-4">
                        ...
                        >
                            ...
                            {processing ? 'Updating...' : 'Update Advisory'}
                        </button>
                    </div>
                </motion.form>
            </motion.div>
